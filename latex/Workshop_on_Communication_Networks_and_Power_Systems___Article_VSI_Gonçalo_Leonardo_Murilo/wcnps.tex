...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{../../article_results/figures/fig_pv_30.pdf}
...
In contrast, the nodal L-Index successfully highlighted the most vulnerable load buses in the 39-bus system as it approached the MLP, demonstrating its analytical robustness and independence from the grid\'s meshing characteristics.
